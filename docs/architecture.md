...
│   │   └── binance.client.ts          # Binance CEX SDK
│   │
│   ├── api/                       # API 라우트
│   │   └── routes/
│   │       ├── status.ts              # 상태 조회
...
- [ ] 전략 클래스 구현
- [ ] WebSocket 실시간 데이터
- [ ] Cron Jobs 구현 → [설계 문서](./external-services-and-cron.md)
- [ ] 백테스팅 모듈
- [ ] 텔레그램 알림
- [ ] 대시보드 UI (React)
...
| 문서                                                             | 설명                                    |
| ---------------------------------------------------------------- | --------------------------------------- |
| [external-data-and-stretegy.md](./external-data-and-stretegy.md) | 외부 API & 트레이딩 전략 상세           |
| [external-services-and-cron.md](./external-services-and-cron.md) | 외부 데이터 서비스 & 크론 스케줄러 설계 |
